...
Step 16 is implemented. On YouTube, the extension reads the currently displayed caption and shows:
...
The extension popup includes an **Enable dual subtitles** checkbox, expanded **Source language** and **Target language** selectors, and a **Translation delay** setting with Fast, Balanced, and Smooth options. Turning the extension off hides the overlay, restores YouTube's native captions, and stops new translation requests.
...
- `popup.js` - Saves the on/off, source language, target language, and translation delay settings.
