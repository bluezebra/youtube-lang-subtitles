...
Step 20 is implemented. On YouTube, the extension reads the currently displayed caption and shows:
...
The extension popup includes an **Enable dual subtitles** checkbox and expanded **Source language** and **Target language** selectors. Turning the extension off hides the overlay, restores YouTube's native captions, and stops new translation requests.
...
- `popup.js` - Saves the on/off, source language, and target language settings.
